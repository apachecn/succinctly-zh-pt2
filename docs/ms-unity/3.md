...
*   [注入属性](http://msdn.microsoft.com/en-us/library/microsoft.practices.unity.injectionproperty.aspx):从Unity注册中设置的属性。
...
| ![](img/tip.png) | 提示:不要忘记调用`LoadConfiguration()`，否则Unity会忽略 XML 配置。 |
