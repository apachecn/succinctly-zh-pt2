...
| ![](../Images/tip.png) | 提示:您需要引用 NHibernate。SqlString 类的 SqlCommand 命名空间。 |
...
| ![](../Images/tip.png) | 提示:你需要参考 NHibernate，NHibernate。类型，系统。组件模型和系统。反射命名空间。 |
...
| ![](../Images/tip.png) | 提示:为命名空间 NHibernate.Event 添加一个使用声明 |
