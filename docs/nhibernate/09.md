...
![](../Images/nonfigure_3_figure_26.png)
...
| ![](../Images/tip.png) | 提示:为 NHibernate 添加使用语句。验证器。验证器和 NHibernate。验证器。引擎名称空间。 |
...
| ![](../Images/tip.png) | 提示:您需要引用命名空间 nhibernate . validator . constraints |
