...
| ![](img/tip.png) | 提示:CSRF 是黑客用来访问网站的常见攻击形式。大多数工具包和框架(包括 Nancy)都有某种形式的保护来抵御这种类型的攻击。如果你想了解更多信息，可以在网上搜索“跨站点请求伪造”或“OWASP 十大问题”路径操作符扩展您在 HTML 代码中拥有的任何路径，以便它们在您的应用程序中正确引用正确的路径。 |
