...
| ![](../images/00004.gif) | 注意:以上几点不是重构的经验法则或原则，这些来自我自己的实践——你可以编译适合你的步骤。 |
...
| ![](../images/00004.gif) | 注意:完整的源代码可以在第 10 章的 Bitbucket 存储库中找到。你也可以用这把小提琴看到工作代码:[https://dotnetfiddle.net/vXg3Lq](https://dotnetfiddle.net/vXg3Lq)。 |
...
| ![](../images/00004.gif) | 注:LSP 是开-闭原理的扩展。 |