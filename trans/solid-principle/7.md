...
| ![](../images/00004.gif) | 注意:“内聚性”指的是任何元素的操作在功能上是如何相关的。 |

| ![](../images/00004.gif) | 注:参考:[https://en . Wikipedia . org/wiki/Cohesion _(computer _ science)](https://en.wikipedia.org/wiki/Cohesion_(computer_science))了解更多关于 Cohesion 的知识。 |
...
| ![](../images/00004.gif) | 注意:当一个接口包含太多操作时，它被称为胖接口或臃肿接口。详见:[https://en.wikipedia.org/wiki/Interface_bloat](https://en.wikipedia.org/wiki/Interface_bloat)。 |
...
| ![](../images/00004.gif) | 注意:这不是完整的代码。完整的源代码请参考 Bitbucket。 |
