...
| ![](../Images/note.png) | 注意:请记住，如果您命名所有使用相同接口的实体，则没有默认实体，如果您尝试解析无参数实体，Unity 将引发异常。 |
...
| ![](../Images/note.png) | 注意:在本章中，我们将推迟到关于区域和区域适配器的更多细节。我们需要区域适配器代码的原因是为了允许非微软用户控件使用 Prism 4 区域。在第 8 章中，我们将详细介绍如何配置和使用 Prism 4 区域适配器。 |
