...
| ![](../Images/note.png) | 注意:我可以使用微软的掩码编辑控件或者 Syncfusion 的数字控件，比如 Integer 文本框控件。这些控件将大大减少解决方案中所需的验证代码量。我使用了常规的文本框控件来展示这种解决方案中的一种验证方法。 |
...
![Math Module Folder Layout.png](../Images/image018.jpg)
