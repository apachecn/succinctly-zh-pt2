...
| ![](../Images/note.png) | 注意:观察者设计模式的 GoF 定义是一对多的结构，它有一个发布者和多个订阅者。Prism 4 事件聚合器使用多对多的结构，可以根据需要容纳任意多的订阅者和发布者。 |
...
![Event Aggregation Graphic.png](../Images/image023.jpg)
...
| ![](../Images/note.png) | 注意:没有必要向统一驾驶员信息中心注册事件聚合器，因为当引导程序启动时，棱镜 4 会自动创建一个事件聚合器。 |
