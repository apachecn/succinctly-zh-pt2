...
| ![](../images/00003.gif) | 注意:ReactDOM 是一个单独维护的库，可以与 React 一起使用来处理浏览器的 DOM。为了能够使用它，您需要在项目中包含它的 CDN 条目或导入它。这个 [JSBin 模板](http://jsbin.com/nufuwas/edit?js,output)有一个用 ReactDOM 安装的组件的工作示例。 |
