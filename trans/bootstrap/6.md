...
那么，我们如何把一个按钮或锚元素变成一个推特Bootstrap按钮呢？就像框架中的其他东西一样，我们添加了一个类。在这种情况下，要添加的主类是“btn”。
...
代码示例 18:基本的推特Bootstrap按钮

如果一切顺利，您应该会在浏览器中看到以下内容:

![](img/image042.jpg)

图 39:基本的推特Bootstrap按钮
...
图 40:推特Bootstrap基本按钮样式

对我来说，描述按钮风格，或者至少是背后的想法的最好方法，就是使用推特Bootstrap文档中的信息。
...
推特Bootstrap中的任何按钮都可以有一个下拉菜单。但是，要使事情正常运行，您必须执行以下操作:

1.  在你的项目中引用推特Bootstrap JavaScript 文件。
