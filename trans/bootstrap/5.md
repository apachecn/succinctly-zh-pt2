...
好吧，使用推特Bootstrap程序，你可以用四行 HTML 5 标记创建这些东西之一。不相信我？尝试将刚才创建的表单示例更改为以下内容:
...
图 31:在推特Bootstrap中呈现的 HTML 5 输入类型
...
根据需要在标签上添加“复选框”或“单选”类，推特Bootstrap程序会将标签与控件对齐，这样您就再也不用担心选项面板的布局是否正确了。
