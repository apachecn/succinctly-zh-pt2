...
| ![](../Images/note.png) | 注意:我们没有传递属性的实际名称——只是在代码中添加了什么来添加属性。 |
...
| ![](../Images/note.png) | 注意:对这段 JavaScript 代码的完整解释超出了本书的范围，但是您可以通过下载和阅读《简洁的 JavaScript》和《简洁的 jQuery》这两本书来获得所需的所有细节。 |
